...
set nox2tics
set noy2tics
set title "Graph 4 (Results.EPYC9654.01/Run.002/FLOPS.004)"
...
set output "Results.EPYC9654.01/Run.002/FLOPS.004/graph4.ps"
plot "Results.EPYC9654.01/Run.002/FLOPS.004/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF
